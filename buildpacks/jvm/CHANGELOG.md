...
- Support for new OpenJDK versions: `1.8.0_504`, `11.0.32.1`, `17.0.20.1`, `21.0.12.1`, `25.0.4.1`, `26.0.2.1`. ([#963](https://github.com/heroku/buildpacks-jvm/pull/963))

## [7.0.13] - 2026-07-22

### Added

- Support for new OpenJDK versions: `1.8.0_502`, `11.0.32`, `17.0.20`, `21.0.12`, `25.0.4`, `26.0.2`. ([#954](https://github.com/heroku/buildpacks-jvm/pull/954))
...
- Support for new OpenJDK versions: `1.8.0_492`, `11.0.31`, `17.0.19`, `21.0.11`, `25.0.3`, `26.0.1`. ([#926](https://github.com/heroku/buildpacks-jvm/pull/926))

## [7.0.10] - 2026-03-18

### Added

- Support for OpenJDK 26. ([#910](https://github.com/heroku/buildpacks-jvm/pull/910))
...
- Support for new OpenJDK versions: `1.8.0_482`, `11.0.30`, `17.0.18`, `21.0.10`, `25.0.2`. ([#855](https://github.com/heroku/buildpacks-jvm/pull/885))

### Changed

- Default version for **OpenJDK 8** is now `1.8.0_482`. ([#885](https://github.com/heroku/buildpacks-jvm/pull/885))
- Default version for **OpenJDK 11** is now `11.0.30`. ([#885](https://github.com/heroku/buildpacks-jvm/pull/885))
- Default version for **OpenJDK 17** is now `17.0.18`. ([#885](https://github.com/heroku/buildpacks-jvm/pull/885))
- Default version for **OpenJDK 21** is now `21.0.10`. ([#885](https://github.com/heroku/buildpacks-jvm/pull/885))
- Default version for **OpenJDK 25** is now `25.0.2`. ([#885](https://github.com/heroku/buildpacks-jvm/pull/885))
...
- Support for new OpenJDK versions: `1.8.0_472`, `11.0.29`, `17.0.17`, `21.0.9`, `25.0.1`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))

### Changed

- Default version for **OpenJDK 8** is now `1.8.0_472`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))
- Default version for **OpenJDK 11** is now `11.0.29`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))
- Default version for **OpenJDK 17** is now `17.0.17`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))
- Default version for **OpenJDK 21** is now `21.0.9`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))
- Default version for **OpenJDK 25** is now `25.0.1`. ([#859](https://github.com/heroku/buildpacks-jvm/pull/859))
...
- Support for new OpenJDK version `24.0.0`. ([#788](https://github.com/heroku/buildpacks-jvm/pull/788))
...
- Default version for **OpenJDK 8** is now `1.8.0_432`. ([#747](https://github.com/heroku/buildpacks-jvm/pull/747))
- Default version for **OpenJDK 11** is now `11.0.25`. ([#747](https://github.com/heroku/buildpacks-jvm/pull/747))
